...
```
npm create cloudflare@latest -- --template=cloudflare/templates/shy-fire-fa7b
```

## Preview Deployment

A live public deployment of this template is available at [https://shy-fire-fa7b.templates.workers.dev](https://shy-fire-fa7b.templates.workers.dev)
